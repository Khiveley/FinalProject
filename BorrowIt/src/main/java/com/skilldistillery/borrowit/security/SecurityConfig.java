package com.skilldistillery.borrowit.security;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .antMatchers(HttpMethod.GET, "/api/products/*/ratings").permitAll()     // will hit the OPTIONS on the route
        .antMatchers(HttpMethod.GET, "/api/products").permitAll()     // will hit the OPTIONS on the route
        .antMatchers(HttpMethod.GET, "/api/borrows").permitAll()     // will hit the OPTIONS on the route
        .antMatchers(HttpMethod.GET, "/api/products/*").permitAll()     // will hit the OPTIONS on the route
        ...
        .antMatchers(HttpMethod.PUT, "/api/borrows/*").permitAll()     // will hit the OPTIONS on the route
        .antMatchers(HttpMethod.GET, "/api/users/*").permitAll()     // will hit the OPTIONS on the route
        .antMatchers(HttpMethod.GET, "/api/ping").permitAll()     // will hit the OPTIONS on the route
        .antMatchers(HttpMethod.GET, "/api/productItem").permitAll()     // will hit the OPTIONS on the route
        .antMatchers(HttpMethod.GET, "/api/productItem/available").permitAll()     // will hit the OPTIONS on the route
//        .antMatchers(HttpMethod.POST, "/api/productItem").permitAll()     // will hit the OPTIONS on the route
        .antMatchers(HttpMethod.PUT, "/api/productItem/*").permitAll()     // will hit the OPTIONS on the route
        .antMatchers(HttpMethod.GET, "/api/borrows/*").permitAll() //
