...
START TRANSACTION;
USE `borrowitdb`;
INSERT INTO `user` (`id`, `username`, `password`, `first_name`, `last_name`, `email`, `create_date`, `address_id`, `enabled`, `role`, `profile_image`) VALUES (1, 'admin', '$2a$10$gAmEOD.fVzfs3RiFR3vRluAEvk0X1GyMsx/UvvPOeWxc/cCaCyAFm', 'Ken', 'Hiveley', 'kenneth.hiveley@gmail.com', NULL, 1, 1, 'ROLE_ADMIN', 'https://m.media-amazon.com/images/I/91RSg9MCGtL._AC_SY450_.jpg');
INSERT INTO `user` (`id`, `username`, `password`, `first_name`, `last_name`, `email`, `create_date`, `address_id`, `enabled`, `role`, `profile_image`) VALUES (2, 'guest', '$2a$10$gAmEOD.fVzfs3RiFR3vRluAEvk0X1GyMsx/UvvPOeWxc/cCaCyAFm', NULL, NULL, NULL, NULL, 3, 1, NULL, NULL);
...
INSERT INTO `user` (`id`, `username`, `password`, `first_name`, `last_name`, `email`, `create_date`, `address_id`, `enabled`, `role`, `profile_image`) VALUES (4, 'imcharlie', '$2a$10$gAmEOD.fVzfs3RiFR3vRluAEvk0X1GyMsx/UvvPOeWxc/cCaCyAFm', 'Charlie', 'Kelly', NULL, NULL, 2, 1, NULL, 'https://upload.wikimedia.org/wikipedia/en/0/0f/Charlie_Kelly.png');
