...
INSERT INTO `user` (`id`, `username`, `password`, `first_name`, `last_name`, `email`, `create_date`, `address_id`, `enabled`, `role`, `profile_image`) VALUES (2, 'guest', '$2a$10$gAmEOD.fVzfs3RiFR3vRluAEvk0X1GyMsx/UvvPOeWxc/cCaCyAFm', NULL, NULL, NULL, NULL, 3, true, NULL, NULL);
...
INSERT INTO `user` (`id`, `username`, `password`, `first_name`, `last_name`, `email`, `create_date`, `address_id`, `enabled`, `role`, `profile_image`) VALUES (4, 'imcharlie', '$2a$10$gAmEOD.fVzfs3RiFR3vRluAEvk0X1GyMsx/UvvPOeWxc/cCaCyAFm', 'Charlie', 'Kelly', NULL, NULL, 2, true, NULL, 'https://upload.wikimedia.org/wikipedia/en/0/0f/Charlie_Kelly.png');
