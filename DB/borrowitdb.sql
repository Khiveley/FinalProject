...
INSERT INTO `product` (`id`, `title`, `description`, `image_url`, `category_id`) VALUES (2, 'John Wick', 'Best \"you messed with the wrong guy\" story I ever saw.', 'https://m.media-amazon.com/images/M/MV5BMTU2NjA1ODgzMF5BMl5BanBnXkFtZTgwMTM2MTI4MjE@._V1_.jpg', 2);
INSERT INTO `product` (`id`, `title`, `description`, `image_url`, `category_id`) VALUES (3, 'Mario Party', 'A videogame of a board game!', 'https://m.media-amazon.com/images/I/91DTMquoGiS._SY445_.jpg', 3);
INSERT INTO `product` (`id`, `title`, `description`, `image_url`, `category_id`) VALUES (4, 'Mario Kart 8', 'A fun racing game!', 'https://m.media-amazon.com/images/I/71pPBrKODxL._AC_SY879_.jpg', 3);
INSERT INTO `product` (`id`, `title`, `description`, `image_url`, `category_id`) VALUES (5, 'Connect 4', 'A two player board game', 'https://target.scene7.com/is/image/Target/GUEST_d86c944e-f500-4967-8810-4bec7d71df86?wid=488&hei=488&fmt=pjpeg', 1);
...
INSERT INTO `product_item` (`id`, `quality`, `product_id`, `user_id`, `version`) VALUES (2, 'Used', 2, 3, 'DVD');
INSERT INTO `product_item` (`id`, `quality`, `product_id`, `user_id`, `version`) VALUES (3, 'Used', 3, 4, 'Standard');
INSERT INTO `product_item` (`id`, `quality`, `product_id`, `user_id`, `version`) VALUES (4, 'New', 4, 4, 'Deluxe Edition');
INSERT INTO `product_item` (`id`, `quality`, `product_id`, `user_id`, `version`) VALUES (5, 'Used', 5, 3, 'Classic');
